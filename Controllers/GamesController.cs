...
namespace RelationsNaN.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var game = await _context.Game.Include(g => g.Platforms).Where(g => g.Id == id).FirstOrDefaultAsync();
            if (game == null)
            {
                return NotFound();
            }
            ...
            ViewBag.Platforms = new SelectList(gamePlatforms, "Id", "Name");
            ViewData["GenreId"] = new SelectList(_context.Genre, "Id", "Name", game.GenreId);
        ...
        public async Task<IActionResult> AddPlatform(int id, int platformId)
        {
            ...
            var platfom = await _context.Platform.FindAsync(platformId);
            if (platfom == null)
            {
                return NotFound();
            }

            game.Platforms.Add(platfom);
